...
BUTTON_FONT = QFont("Montserrat", 14)
...
STYLESHEET = {
    ...
    "primary_label": "color: #66FCF1; font-size: 35px; font-weight: bold; text-align: center;",
    "sub_label": "color: #C5C6C7; font-size: 18px; text-align: center;",
    "button": """
        QPushButton {
